...
For clarity, we dedicated this section to formally present the notation used in this paper.Vectors are represented by normal font variables, i.e. $a,x,y,z$.
...
\textit{Estimation} vectors are represented with a \textit{hat} on top, i.e. $\widehat{a},\widehat{x},\widehat{Y},\widehat{Z}$.
