...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 10) && (mxGetN(xm) == 13))) {
      printf("A must be size (10,13), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 13) && (mxGetN(xm) == 13))) {
      printf("Q must be size (13,13), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  *mxGetPr(xm) = work.converged;
  ...
  xm = mxCreateDoubleMatrix(13, 1, mxREAL);
