...
% path = '../../mout/nbug_QuEst_T_matlab.txt'; writematrix(T,path,'Delimiter',' ');
% path = '../../mout/nbug_QuEst_Z1_matlab.txt'; writematrix(Z1,path,'Delimiter',' ');
% path = '../../mout/nbug_QuEst_Z2_matlab.txt'; writematrix(Z2,path,'Delimiter',' ');
% path = '../../mout/nbug_QuEst_qt_Res_matlab.txt'; writematrix(Res,path,'Delimiter',' ');
