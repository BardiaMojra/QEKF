...
%
% Ver 7_8_spd:
%           -  Speeded up version of QuEst
%           -  Can be used for Mex/C++ code generation
%           -  SVD and eig are called as exterinsic functions
%           -  Uses only B1 to find solutions
%           -  Slightly less accurate, but faster    
%
%
function [Q] = QuEst_5Pt_Ver7_8_spd(m,n)
...
% NOTE: The following lines are needed for Mex/C++ code generation    
V1 = complex(zeros(20));
V = zeros(56);
