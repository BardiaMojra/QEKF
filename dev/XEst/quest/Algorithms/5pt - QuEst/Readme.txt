This folder contains the Matlab implementation of the QuEst algorithm.

Example.m: Is a demo file that shows how QuEst can be used to estimate the relative pose from two images using 5 or more matched feature points.

QuEst_Ver1_1: The implementation of QuEst algorithm that recoveres the rotation, translation, and depths.


Copyright (C) 2013-2017, under the GNU lesser General Public License, by Kaveh Fathian.
...
QuEst_5Pt_Ver5_2: Part of QuEst implementation that recoveres the rotation (as explained in the paper).
